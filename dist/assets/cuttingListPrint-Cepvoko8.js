import{h as I,i as R,j as z,E as D,o as u,c as d,d as o,t as r,a as h,w as m,k as E,F as q,l as F,g as _,m as U,r as k,n as A,b as G,f as p}from"./index-Bt6OeKxc.js";import{c as J}from"./index-B4g6DhIn.js";const O={class:"print-root"},Y={class:"print-toolbar no-print"},K={class:"ttl"},Q={class:"toolbar-right"},W={key:0,class:"state-tip no-print"},X={key:1,class:"state-tip no-print"},Z={key:2,class:"cut-sheet ledger"},w={class:"sheet-title"},tt={class:"cut-table"},et=["innerHTML"],nt={class:"sheet-foot"},lt=`
  <tr>
    <th>客户名称</th>
    <th>订单号</th>
    ...
    <th>门扇(mm)<br>高*宽</th>
    <th>板材</th>
  </tr>`,b="print-page-orient",rt={__name:"cuttingListPrint",setup(st){const $=U(),C=G(),f=_("single"),l=_([]),v=_(!0);function S(t){if(!t)return[];try{const e=JSON.parse(t);return Array.isArray(e)?e.filter(a=>typeof a=="string"&&a):[]}catch{return[]}}function c(t){return t!=null&&t!==""?Math.round(Number(t)):null}function V(t){const e=S(t.remark_tags),a=e.length?" "+e.map(n=>"【"+n+"】").join(""):"",y=(t.remark||"")+a,s=n=>`<td>${n!=null&&n!==""?n:"-"}</td>`,i=t.wall_thick!=null?t.wall_thick:t.wall_thickness!=null?t.wall_thickness:null,x=[c(t.hole_height),c(t.hole_width),c(i)],P=x.some(n=>n!==null)?x.map(n=>n===null?"-":n).join("*"):"-",B=[c(t.door_height),c(t.door_width)],j=B.some(n=>n!==null)?B.map(n=>n===null?"-":n).join("*"):"-";return`
    ${s(t.customer)}
    ${s(t.order_no)}
    <td>${P}</td>
    ${s(t.style)}
